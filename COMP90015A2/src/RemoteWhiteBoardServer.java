...
//        String collectionName = args[1];
     ...
     * @param port
     */
    public RemoteWhiteBoardServer(int port, String collectionName) {
        this.port = port;
        ...
        try {
            ...
            while (true) {
                try {
                    ...
                    RemoteWhiteBoardThread clientThread = new RemoteWhiteBoardThread(socket, this.remoteWhiteBoardMongoDB, this.collectionName, this.canvas, UUID.randomUUID(), this.threads);
